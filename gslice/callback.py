...
from gslice.utils import Setting
from gslice.utils.plots import plot_figures
        ...
        if (pl_module.current_epoch + 1) % self.eval_every == 0:
            ...
            for tag, dataset in self.datasets.items():
                ...
                if pl_module.setting != Setting.UNIVARIATE:
                    raise ValueError(f"Unsupported setting {pl_module.setting!r}; only 'univariate' is supported.")
