...
def cauchy_naive(v, z, w):
    """Pure PyTorch Cauchy kernel. Numerically stable in backward pass.
    v, w: (..., N)
    z: (..., L)
    returns: (..., L)
    """
...
class SSKernelNPLR(OptimModule):
    ...
    def forward(self, state=None, rate=1.0, L=None):
        ...
        # NOTE: Always use cauchy_naive (pure PyTorch) instead of KeOps.
        # The KeOps cauchy_conj backward pass produces NaN gradients for w
        # due to numerical overflow in its auto-differentiated kernel.
