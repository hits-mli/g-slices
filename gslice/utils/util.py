...
from gslice.irregular import TIME_GRID_FIELD
...
@contextmanager
def temporary_random_seed(seed: Optional[int]):
    if seed is None:
        yield
        return
    ...
    *,
    ...
    splitter = InstanceSplitter(
        ...
        time_series_fields=[
            ...
            *([TIME_GRID_FIELD] if include_time_grid else []),
        ],
    )
    return splitter
